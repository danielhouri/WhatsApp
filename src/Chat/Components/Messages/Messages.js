...
function Messages(props) {
  ...
  return (
    <div className="messages">
      ...
      <MessagesBody listChat={getMessageByUsername(props.username, props.loginDetails.username)} />
      ...
      <VoicePopUp show={voiceMessage} handleClose={handleCloseVoice} username={props.username} refresh={props.refresh} setRefresh={props.setRefresh} ownerUsername={props.ownerUsername} />
      <ImagePopUp username={props.username} refresh={props.refresh} setRefresh={props.setRefresh} ownerUsername={props.ownerUsername} />
      <VideoPopUp username={props.username} refresh={props.refresh} setRefresh={props.setRefresh} ownerUsername={props.ownerUsername} />
    </div>
  )
}
